...
Revision ID: bf33199c44f8
Revises: 
Create Date: 2024-07-03 12:32:51.233854
...
def upgrade() -> None:
    ...
    sa.Column('code_owner', sa.String(length=55), nullable=False),
    ...
    sa.Column('strenght', sa.Float(), nullable=False),
    sa.Column('npp', sa.Integer(), nullable=False),
